...
## Project Structure
    ...
    ├── testapiautosetting_126356  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126356`
...
2. Clone this repo and `cd testapiautosetting_126356`
